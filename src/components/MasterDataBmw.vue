                ...
                <div class="table-box">
                    <div class="select-content">
                            <div class="select-box">
                                <el-select class="select" multiple collapse-tags v-model="conditions.series" @change="getBmwESeriesList();getBmwModelsList();search(1, false)" placeholder="Series">
                                    <el-option
                            ...
                            <div class="select-box">
                                <el-select class="select" multiple collapse-tags v-model="conditions.eSeries" @change="getBmwModelsList();search(1, false)" placeholder="E-Series">
                                    <el-option
                            ...
                            <div class="select-box">
                                <el-select class="select" multiple collapse-tags v-model="conditions.model" @change="search(1, false)" placeholder="Model">
                                    <el-option
