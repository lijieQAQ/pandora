    ...
    <div class="modal fade" id="saveModal">
      <div class="modal-dialog editModal saveModal">
        ...
        <div class="modal-footer">
          <div class="btnBox">
            <button type="submit" class="btn btn-default btnCancel" data-dismiss="modal" @click='closeSaveVersion()'>Cancel</button>
...
export default {
  ...
  methods:{
    ...
    saveData: function () {
      ...
      //待改
      // $('.loadingDiv').show();
      self.$http.get('/priceladder/saveVersion', {params: JSON.stringify(route)}).then(res => {
        if (res.status == 200) {
