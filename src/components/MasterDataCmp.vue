        ...
        <div class="table-box">
          <div class="select-content">
            <div class="select-box">
              <el-select multiple collapse-tags id="brand" name="brand" class="select" v-model="conditions.brand"
                         @change="getCmpModelList();search(1, false)" placeholder="Brand">
                <el-option
            ...
            <div class="select-box">
              <el-select multiple collapse-tags id="Model" name="Model" class="select" v-model="conditions.model"
                         @change="getCmpModelRangeList();search(1, false)" placeholder="Model">
                <el-option
            ...
            <div class="select-box">
              <el-select multiple collapse-tags id="ModelRange" name="ModelRange" class="select"
                         v-model="conditions.modelRange" @change="getCmpEngineList();search(1, false)"
                         placeholder="Model_Range">
                <el-option
            ...
            <div class="select-box">
              <el-select multiple collapse-tags id="Engine" name="Engine" class="select" v-model="conditions.engine"
                         @change="search(1, false)" placeholder="Engine">
                <el-option
