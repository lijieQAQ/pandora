  ...
  >
    <div class="modal-dialog editModal addModal">
      ...
      <div class="modal-content">
        <div class="modal-body">
          <fieldset class="select-box">
            <div class="control-group">
              <div class="controls input-append">
                ...
                <div id="Brand">
                  <template>
                    <el-select id="addMenuRowBrand" v-model="addRow.brand" placeholder="" default-first-option
                               @change="changeBrand()" v-bind:disabled="addRow.addCarShowFlg">
            ...
            <div class="control-group">
              <div class="controls input-append">
                <label for="name"><b class="text-danger">*</b>{{ addRow.brand ? (addRow.isBmwProduct ? 'Series' :
                  'Model') : 'Series/Model' }} </label>
                <div id="seriesAndModel">
                  <template>
                    <el-select id="addMenuRowSeriesOrModel" v-model="addRow.seriesOrModel" placeholder="" filterable=""
                               allow-create="" default-first-option @change="changeSeriesOrModel()"
            ...
            <div class="control-group">
              <div class="controls input-append">
                <label for="name"><b class="text-danger">*</b>{{ addRow.brand ? (addRow.isBmwProduct ? 'E-Series' :
                  'Engine') : 'E-Series/Engine' }}</label>
                <div id="eseriesAndEngine">
                  <template>
                    <el-select id="addMenuRowEseriesOrEngine" v-model="addRow.eseriesOrEngine" placeholder=""
                               filterable="" allow-create="" default-first-option
                               @change="searchRowDetail('menuhubAddRowDate')" v-bind:disabled="addRow.addCarShowFlg">
                      <el-option
          ...
          <div class="checkBox" v-if="!addRow.addCarShowFlg">
            <a href="javascript:void(0)" class="addMaskTitle" @click="showAddNewCar(true, true)">Add New Vehicle<img
              src="../assets/images/addNewOne.png">
            </a>
            <div id="checkBox">
      ...
      <div class="modal-footer">
        <div class="btnBox">
          <button type="submit" class="btn btn-default btnCancel" data-dismiss="modal" @click="closeAddNewCarModal()">
            Cancel
          </button>
          <button type="button" class="btn btn-primary btnConfirm"
                  v-bind:class="{ noUseBtn : (addRow.selectedProduct.length == 0) }"
                  v-bind:disabled="addRow.selectedProduct.length == 0" @click="confirmMenuhubAddRow()">Submit
          </button>
        </div>
      </div>
    </div>
