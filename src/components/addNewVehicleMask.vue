<template>
  <el-dialog
          ...
          <fieldset class="select-box">
            <div class="control-group">
              <div class="controls input-append">
                ...
                <div id="Brand">
                  <template>
                    <el-select id="addRowBrand" v-model="addRow.brand" default-first-option @change="changeBrand('addRowDate')" v-bind:disabled="addRow.addCarShowFlg">
            ...
            <div class="control-group">
              <div class="controls input-append">
                ...
                <div id="seriesAndModel">
                  <template>
                    <el-select id="addRowSeriesOrModel" v-model="addRow.seriesOrModel" filterable="" allow-create="" default-first-option @change="changeSeriesOrModel('addRowDate')" v-bind:disabled="addRow.addCarShowFlg" maxlength="13">
            ...
            <div class="control-group">
              <div class="controls input-append">
                ...
                <div id="eseriesAndEngine">
                  <template>
                    <el-select id="addRowEseriesOrEngine" v-model="addRow.eseriesOrEngine" filterable="" allow-create="" default-first-option @change="searchRowDetail('addRowDate')" v-bind:disabled="addRow.addCarShowFlg">
                      <el-option
            ...
            <div id="checkBoxTwo">
              <div class="control-group">
                <div class="controls input-append">
                  ...
                  <input type="text" value="F20" v-model="addRow.addCar.carNameEn" maxlength="50" name="addRow.addCar.carNameEn" v-validate="'required'">
              ...
              <div class="control-group">
                <div class="controls input-append">
                  ...
                  <input type="text" v-model="addRow.addCar.nickname" maxlength="19" name="addRow.addCar.nickname" v-validate="'required'">
              ...
              <div class="control-group">
                <div class="controls input-append widthHalf">
                  ...
                  <input type="text" v-model="addRow.addCar.model" v-bind:disabled="!addRow.isBmwProduct" maxlength="20" name="addRow.addCar.model" v-validate="'required'">
              ...
              <div class="control-group">
                <div class="controls input-append widthHalf" v-if="addRow.isBmwProduct">
                  ...
                  <input type="text" v-model="addRow.addCar.packageCode" maxlength="20" name="addRow.addCar.packageCode" v-validate="'required'">
                  <div class="sixErrorTip">{{ errors.first('addRow.addCar.packageCode') }}</div>
                </div>
                <div class="controls input-append widthHalf" v-if="!addRow.isBmwProduct">
                  <label for="name"><b class="text-danger">*</b>Engine</label>
                  <input type="text" v-model="addRow.addCar.engine" disabled="true" maxlength="20" name="addRow.addCar.engine" v-validate="'required'">
    ...
    <el-button  data-dismiss="modal">Cancel</el-button>
    <el-button v-bind:class="{ noUseBtn : (addRow.selectedProduct.length == 0) }" v-bind:disabled="addRow.selectedProduct.length == 0" @click="confirmAddRow(),createArrow()" >Submit</el-button>
  </span>
  </el-dialog>
</template>
